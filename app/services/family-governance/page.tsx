...
export default function FamilyGovernancePage() {
  const offerings = [
    ...
    {
      icon: Shield,
      title: "Wealth structuring and asset protection strategies",
    },
    {
      icon: ArrowRightLeft,
      title: "Succession planning and generational wealth transfer",
    },
      ...
      <section className="py-16 md:py-20 bg-[#F9F7F2]">
        <div className="relative max-w-5xl mx-auto px-8 text-center">
          <h2 className="font-serif text-3xl md:text-4xl text-primary mb-6 leading-tight text-balance">
            Bespoke wealth preservation strategies, asset protection solutions
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          ...
          <div className="space-y-6 text-justify font-sans text-base md:text-lg leading-relaxed text-primary/80">
            <p>
              We are trusted advisers to Middle Eastern and international
              families, supporting them with complex cross‑border structuring,
              family governance and wealth preservation strategies. Our
              expertise spans tax‑efficient ownership structures, asset
              protection and estate planning. We can advise
              our clients on tax efficient cross-border structures and work in
              collaboration with our lawyers to navigate through the complex
              rules of inheritance and succession, ensuring efficient succession
              planning to intended beneficiaries, including trusts and
              foundation structures.
            </p>

            <p>
              We support clients with trust planning, UAE foundations and work
              with our partners across multiple jurisdictions to advise clients
              on robust family governance frameworks and structures. We work
              closely with our clients to ensure our advice is tax efficient and
              in line with our clients’ long term commercial and strategic
              objectives. Our experienced team can also advise on appropriate
              ownership structures, to ensure the smooth management of multiple
              asset portfolios.
            </p>

            <p>
              We also provide ongoing compliance support to families as part of
              our accounting and tax compliance services.
            </p>
          </div>
